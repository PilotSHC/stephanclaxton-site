...
She is not wrong because the interventions are useless. They are not useless. Parameters do matter. Numbers do matter. Tuning a planner is real work that produces real improvement. The point is that the system's behavior is not actually being produced by the parameter values. It is being produced by something further upstream, and adjusting the parameter is a way of compensating for the upstream structure rather than changing it.
